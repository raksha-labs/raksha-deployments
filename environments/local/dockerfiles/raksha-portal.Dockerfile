...
ARG NEXT_PUBLIC_RISK_DASHBOARD_URL=https://dashboard.rakshalabs.io
...
EXPOSE 3000
ENV PORT=3000
ENV NEXT_PUBLIC_RISK_DASHBOARD_URL=https://dashboard.rakshalabs.io
ENV RAKSHA_RISK_DASHBOARD_URL=https://dashboard.rakshalabs.io
